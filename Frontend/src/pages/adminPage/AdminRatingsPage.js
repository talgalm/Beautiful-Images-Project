...
import {
  handleGetAllImages,
  handleGetImageRatings,
  handleGetRatingsPaginated,
...
const AdminRatingsPage = () => {
  ...
  const fetchRatings = async () => {
    if (selectedImageId) {
      handleGetImageRatings("admin@gmail.com", selectedImageId).then(
        (response) => {
      ...
      for (const imageId of categoryImageIds) {
        const response = await handleGetImageRatings(
          "admin@gmail.com",
          imageId
        );
      ...
      const response = await handleGetRatingsPaginated(
        "admin@gmail.com",
        currentPage,
        itemsPerPage
      );
  ...
  const filteredImages = images.filter(
    (img) => img.imageCategory === selectedCategory
  );
    ...
    <div>
      ...
      <div className="container mt-4">
        ...
        <div className="d-flex justify-content-center mt-4">
          ...
          <div className="mt-2" hidden={!showPagination()}>
            {" "}
